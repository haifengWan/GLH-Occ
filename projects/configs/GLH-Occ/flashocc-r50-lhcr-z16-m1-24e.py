...
model = dict(
    ...
    # LHCR-only. Default setting used by the main single-module ablation.
    # For the latent-height ablation, change lhcr_latent_height to 8 or 32.
    ...
    # Original FlashOcc M1 image path: P16 is used by the standard LSS branch.
    # P8/P32 MS-BEV branches are not constructed.
    img_backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
work_dir = './work_dirs/flashocc-r50-lhcr-z16-m1-24e'
