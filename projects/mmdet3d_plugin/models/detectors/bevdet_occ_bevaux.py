...
class BEVDetOCCBEVAux(BEVDetOCC):
    """
    FlashOcc + Occupancy-derived GT-BEV auxiliary supervision.

    This class keeps the original FlashOcc occupancy pipeline unchanged:
        occ_bev_feature -> BEVOCCHead2D -> loss_occ

    It only adds a training-time BEV auxiliary semantic head:
        occ_bev_feature -> BEV Aux Head -> loss_bev_aux

    The auxiliary head is not used during inference.
    """
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(BEVDetOCCBEVAux, self).__init__(**kwargs)
    ...
    def build_bev_multihot_target(self, voxel_semantics, mask_camera):
        """
        Build BEV-level multi-hot semantic targets from voxel-level occupancy GT.

        Args:
            voxel_semantics: Tensor, shape (B, Dx, Dy, Dz)
                Semantic occupancy labels. Usually:
        ...
        # Multi-hot semantic target over classes 0-16. Class 17/free is not a positive class.
        target_list = []
    ...
    def loss_bev_aux(self, bev_logits, voxel_semantics, mask_camera):
        ...
        # Align target to bev_logits spatial size if needed.
        ...
        # BCE for multi-label BEV semantics.
        ...
        # Dynamic positive reweighting.
        # This prevents rare positive classes from being overwhelmed by many negative labels.
        with torch.no_grad():
    ...
    def forward_train(self,
                      ...
                      **kwargs):
        """
        Forward training with original occupancy loss and GT-BEV auxiliary loss.
        """
        ...
        # 2. Training-only GT-BEV auxiliary semantic supervision.
